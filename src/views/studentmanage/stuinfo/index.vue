  ...
  <div>
    <BasicTable @register="registerTable">
      <template #toolbar>
        ...
        <a-button type="primary" @click="handleCreate"> 新增学生信息 </a-button>
      </template>
...
<script setup>
  ...
  import { getPageInfo, deleteItem, getExport, uploadApi, getSysFile } from '@/api/stuInfo';
  ...
  async function getExportData() {
    ...
    downloadByData(data, `学生信息${formattedTime}.xlsx`);
    closeFullLoading();
  }
  ...
  const getDownload = async () => {
    ...
    console.log(data);
    downloadByData(data, `学生行为规范.xlsx`);
    closeFullLoading();
  };
