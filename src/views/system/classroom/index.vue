  ...
  <div>
    <BasicTable @register="registerTable">
      <template #toolbar>
        ...
        <a-button type="primary" @click="handleCreate"> 新增教室 </a-button>
      </template>
...
<script setup>
  ...
  import { getPageInfo, deleteItem, getExport, uploadApi, getTemplateFile } from '@/api/classroom';
  ...
  async function getExportData() {
    ...
    downloadByData(data, `教室管理${formattedTime}.xlsx`);
    closeFullLoading();
  }
  ...
  const getDownload = async () => {
    ...
    const data = await getTemplateFile({
      TemplateCode: 'student_code_of_conduct ',
    });
    console.log(data);
    downloadByData(data, `教室管理.xlsx`);
    closeFullLoading();
  };
