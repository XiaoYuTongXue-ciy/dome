<template>
  <div>
    <BasicTable @register="registerTable">
      <template #toolbar>
        <a-button type="primary" @click="handleCreate"> 新增教案 </a-button>
      </template>
...
<script setup>
  ...
  import { getPageInfo, deleteItem, getSysFile } from './api';
  ...
  const handleDownload = async (record) => {
    ...
    const { fileName, suffix } = record.fileInfo;
    const name = fileName && suffix ? fileName + suffix : `教案管理_${formattedTime}.docx`;
