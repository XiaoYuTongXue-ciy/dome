...
<script setup>
  ...
  import { getPageInfo, deleteItem, getExport, getTemplateFile, uploadApi } from '@/api/course';
  ...
  async function getExportData() {
    ...
    downloadByData(data, `课程_${formattedTime}.xlsx`);
    closeFullLoading();
  }
