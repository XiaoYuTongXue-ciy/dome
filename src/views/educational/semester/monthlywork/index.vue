  ...
  <div>
    <BasicTable @register="registerTable">
      <template #toolbar>
        ...
        <a-button type="primary" @click="handleCreate">新增月度工作安排</a-button>
      </template>
...
<script setup>
  ...
  import { getPageInfo, deleteItem, getExport } from '@/api/semester/monthlyWork.js';
  ...
  async function getExportData() {
    ...
    downloadByData(data, `月度工作安排_${formattedTime}.xlsx`);
    closeFullLoading();
  }
</script>
