  ...
  return [
    ...
    },
    {
      ...
      customRender: ({ text, record }) => {
        ...
        if (uploadStatus === UploadResultStatus.ERROR) {
          ...
          status = 'success';
        } else if (uploadStatus === UploadResultStatus.WARNING) {
          warning = true;
        }
        return (
          <div>
    ...
    },
    {
      ...
      customRender: ({ text }) => {
        ...
        } else if (text === UploadResultStatus.WARNING) {
          return <Tag color="warning">{'可重新上传'}</Tag>;
        }
